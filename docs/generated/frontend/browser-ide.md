...
- Terminal is the native VS Code integrated terminal only. No separate xterm terminal in the Angular UI.
...
- Angular UI holds workspaces, open, account, and admin; the normal light editor lives there too.
